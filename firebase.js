...
// Con la libreria compat la regione va passata al servizio dell'app,
// non direttamente alla funzione globale Firebase.
const funzioniFirebase = firebase.app().functions("europe-west1");
